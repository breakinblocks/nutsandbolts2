...
furnace.remove(<ore:ingotCorten>);
furnace.remove(<ore:ingotTungsteel>);
furnace.remove(<ore:ingotNichrome>);
...
furnace.addRecipe(<immersiveengineering:metal:4>,<ore:dustNickel>, 4.5);
furnace.addRecipe(<ic2:dust:15> *2, <minecraft:stone>, 4.5);


furnace.addRecipe(<minecraft:iron_ingot>, <ore:dustIron>, 4.5);
furnace.addRecipe(<minecraft:gold_ingot>, <ore:dustGold>, 4.5);
furnace.addRecipe(<ic2:ingot:6>, <ore:dustTin>, 4.5);
furnace.addRecipe(<ic2:ingot:2>, <ore:dustCopper>, 4.5);
furnace.addRecipe(<immersiveengineering:metal:1>, <ore:dustAluminum>, 4.5);
furnace.addRecipe(<ic2:ingot:3>, <ore:dustLead>, 4.5);
furnace.addRecipe(<ic2:ingot:4>, <ore:dustSilver>, 4.5);
furnace.addRecipe(<mekanism:Ingot:1>, <ore:dustOsmium>, 4.5);
