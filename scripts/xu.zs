...
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_overclock"}), [[<rockhounding_chemistry:alloyBItems:19>, <deepresonance:spent_filter>, <rockhounding_chemistry:alloyBItems:19>], [<mekanism:ControlCircuit:3>, <extrautils2:machine>, <mekanism:ControlCircuit:3>], [<rockhounding_chemistry:alloyBItems:19>, <actuallyadditions:blockCrystalEmpowered:5>, <rockhounding_chemistry:alloyBItems:19>]]);
...
recipes.addShaped(<extrautils2:quarry>, [[<rockhounding_chemistry:alloyBItems:19>, <ic2:charging_lapotron_crystal:1>, <ore:ingotOsmiridium>], [<ic2:mining_laser:26>, <ore:netherStar>, <ic2:mining_laser:26>], [<ore:ingotOsmiridium>, <enderio:blockCapBank:3>, <rockhounding_chemistry:alloyBItems:19>]]);
