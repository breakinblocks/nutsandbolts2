...
recipes.addShaped(<woot:dye:6>, [[null, <ore:crystalGold>, null], [<ic2:casing:5>, <enderio:blockEndermanSkull:2>, <ic2:casing:5>], [null, <ore:ingotManyullyn>, null]]);
...
recipes.addShaped(<gendustry:GeneTemplate>, [[null, <gendustry:GeneSampleBlank> ], [<gendustry:GeneSampleBlank>, <actuallyadditions:itemCrystalEmpowered:4>, <gendustry:GeneSampleBlank>], [null, <gendustry:GeneSampleBlank>]]);
...
recipes.addShaped(<botania:pool:1>, [[<bloodmagic:ItemBloodShard:1>, <forestry:crated.forestry.pollen.1>, <bloodmagic:ItemBloodShard:1>], [<forge:bucketFilled>.withTag({FluidName: "ic2uu_matter", Amount: 1000}), <botania:manaTablet>.withTag({mana: 500000}), <forge:bucketFilled>.withTag({FluidName: "ic2uu_matter", Amount: 1000})], [<minecraft:end_crystal>, <draconicevolution:crafting_pedestal:3>, <minecraft:end_crystal>]]);
...
recipes.addShaped(<appliedenergistics2:molecular_assembler>, [[<appliedenergistics2:quartz_vibrant_glass>, <ore:oc:microcontrollerCase2>, <appliedenergistics2:quartz_vibrant_glass>], [<gravisuite:crafting:1>, <advanced_solar_panels:crafting:6>, <gravisuite:crafting:1>], [<appliedenergistics2:quartz_vibrant_glass>, <gravisuite:crafting:1>, <appliedenergistics2:quartz_vibrant_glass>]]);
...
recipes.addShaped(<enderio:blockInventoryPanel>, [[<appliedenergistics2:quartz_glass>, <rscircuits:resource:2>, <appliedenergistics2:quartz_glass>], [<arsmagica2:magic_wall>, <enderio:itemMaterial:6>, <arsmagica2:magic_wall>], [<appliedenergistics2:quartz_glass>, <rscircuits:resource:1>, <appliedenergistics2:quartz_glass>]]);
...
recipes.addShaped(<enderio:blockEnchanter>, [[null, <arsmagica2:essence:1>, null], [<extrautils2:decorativesolidwood:1>, <enderio:itemXpTransfer>, <extrautils2:decorativesolidwood:1>], [<ic2:casing:5>, <botania:storage>, <ic2:casing:5>]]);
